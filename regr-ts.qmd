...
El modelo autorregresivo de orden 1, `\AR{1}`{=latex}, puede escribirse
como:
$$
...
Las propiedades dinámicas del proceso `\AR{1}`{=latex} dependen del
valor de $\rho$:
...
-   Si $y_t$ sigue un proceso `\AR{p}`{=latex} es necesario incluir
